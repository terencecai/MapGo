...
private function UpdateZooming() {
	...
	if (Input.touchCount == 2) {
		...
		var prevZeroPos = touchZero.position - touchZero.deltaPosition;
		var prevOnePos = touchOne.position - touchOne.deltaPosition;

		var prevTouchDeltaMag = (prevZeroPos - prevOnePos).magnitude;
		var touchDeltaMag = (touchZero.position - touchOne.position).magnitude;

		deltaZoom += (prevTouchDeltaMag - touchDeltaMag) * mouseZoomMultiplier;
	}
